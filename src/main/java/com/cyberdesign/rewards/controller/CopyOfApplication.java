...
import com.cyberdesign.rewards.config.AppConfig;
import com.cyberdesign.rewards.model.BadCustomer;

@SpringBootApplication
@ComponentScan("com.cyberdesign.rewards.*")
public class CopyOfApplication implements CommandLineRunner {

	private static final Logger log = LoggerFactory
			.getLogger(CopyOfApplication.class);
